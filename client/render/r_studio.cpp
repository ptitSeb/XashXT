...
void CStudioModelRenderer::StudioCalcAttachments( void )
{
	...
	{
		m_pCurrentEntity->attachment[i] = m_pbonetransform[pattachment[i].bone].VectorTransform( pattachment[i].org );
		...
		m_pbonetransform[pattachment[i].bone].GetOrigin( bonepos );
